...
module API
  class FollowersController < ApplicationController
    before_action :set_follower, only: %i[show destroy]
    ...
    def follows_show
      ...
      render json: { error: "You are not following #{@user.username}" }, status: :conflict unless @follower
    end
